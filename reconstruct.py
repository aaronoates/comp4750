...
#Note: I am aware that this script does not work for all test cases. I tried my best but couldn't get it in time. So as a plan B, I wrote comments for everything so you can at least see what I TRIED to do.
